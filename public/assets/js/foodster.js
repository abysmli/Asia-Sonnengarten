...
$(function () {
    ...
    $("input,textarea").jqBootstrapValidation({
        ...
        submitSuccess: function ($form, event) {
            ...
            var name = $("input#last_name1").val() + ', ' + $("input#first_name1").val();
            ...
            $.ajax({
                ...
                success: function () {
                    ...
                    $('#success > .alert-success')
                        .append("<strong>Ihre Reservierung wird erfolgreich eingekommen.</strong>");
                    $('#success > .alert-success')
                        .append('</div>');
...
function loadGoogleMap() {
    ...
    var mapPoint = {
        ...
        'zoom': 17,
        'infoText': '<p>东方红中餐\
                                <br/>China Restaurant Sonnengarten\
                                <br/>Christophstraße 14\
                                <br/>70178 Stuttgart</p>',
        'linkText': '在Google地图上查看',
        'mapAddress': 'Christophstraße 14, 70178 Stuttgart',
